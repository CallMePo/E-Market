    ...
    <div>
        ...
        <div class="sign-in-container">
            <div class="sign-in-log-in">
                ...
                <div class="sign-in-input-text">
                    <div class="card-body">
                        ...
                        <form action="{{ route('signin') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="d-grid">
                                    <button class="btn btn-primary btn-block btn-brown">Sign In</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <a href="{{ route('home') }}" class="sign-in-button-primary">
                ...
                <a href="{{ route('register') }}" class="sign-in-text12 UI-16Medium">
                    <span>Sign Up</span>
                </a>
                <a href="{{ route('home') }}" class="sign-in-text14 UI-16Medium">
                    x
                </a>
            </div>
        </div>
